        ...
        <div class="card card-primary card-outline direct-chat direct-chat-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <form action="{{ Route('closeDisputeAppealMessageMethod', ['id' => $appealId]) }}" method="GET" style="display: inline-block">
                        @method('GET')
                            ...
                            <div class="direct-chat-msg">
                                ...
                                <div class="direct-chat-text">
                                    ...
                                    @if($message->path_to_image)
                                        <img src="{{ $message->path_to_image }}" alt="."
                                        style="width: 300px">
                                    @endif
                                </div>
                                <!-- /.direct-chat-text -->
            ...
            <div class="card-footer">
                <form action="{{ Route('sendDisputeAppealMessageMethod', ['id' => $appealId]) }}" method="post">
                    @csrf
                    @method('POST')
