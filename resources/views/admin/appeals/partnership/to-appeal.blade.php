        ...
        <div class="card card-primary card-outline direct-chat direct-chat-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <form action="{{ Route('closePartnershipAppealMessageMethod', ['id' => $appealId]) }}" method="GET" style="display: inline-block">
                        @method('GET')
            ...
            <div class="card-footer">
                <form action="{{ Route('sendPartnershipAppealMessageMethod', ['id' => $appealId]) }}" method="post">
                    @csrf
                    @method('POST')
