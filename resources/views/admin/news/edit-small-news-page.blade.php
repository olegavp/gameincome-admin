...
@section('title', 'Редактирование маленькой новости')
        ...
        <form enctype="multipart/form-data" action="{{ Route('editSmallNews', ['news' => $news->id]) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group mt-2">
                    ...
                    <input value="{{ $news->description_on_3_words }}" name="description_on_3_words" type="text" class="form-control @error('name') is-invalid @enderror" id="description_on_3_words" placeholder="Введите описание в «трёх словах»">
