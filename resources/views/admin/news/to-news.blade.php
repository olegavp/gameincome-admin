        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <h5>Описание в «трёх словах»:</h5>
                    <p>{{$news->description_on_3_words}}</p>
                ...
                <nav class="w-100">
                    <div class="nav nav-tabs" id="product-tab" role="tablist">
                        <a class="nav-item nav-link active" id="product-desc-tab" data-toggle="tab" href="#product-desc"
                           role="tab" aria-controls="product-desc" aria-selected="true">Полное описание</a>
                        <a class="nav-item nav-link" id="product-comments-tab" data-toggle="tab"
                           href="#product-comments" role="tab" aria-controls="product-comments" aria-selected="false">Комментарии</a>
                        <a class="nav-item nav-link" id="product-rating-tab" data-toggle="tab" href="#product-rating"
                           role="tab" aria-controls="product-rating" aria-selected="false">Похожие новости</a>
                    </div>
                </nav>
                                ...
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm"
                                             src="{{ \App\Models\User::query()->find($comment->user_id)->avatar }}"
                                             alt="аватар">
                                        <span class="username">
                                    ...
                                    @if($comment->deleted_at != null)
                                        <form action="{{ Route('trashBoxNewsCommentRestore', ['id' => $comment->id]) }}"
                                              method="GET">
                                            @csrf
                                            @method('GET')
                                    ...
                                    @if($comment->deleted_at == null)
                                        <form action="{{ Route('deleteNewsComment', ['newsComment' => $comment->id]) }}"
                                              method="POST">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            <a class="btn btn-primary btn-sm"
                                               href="{{ Route('toNews', ['news' => $relation->id]) }}">
