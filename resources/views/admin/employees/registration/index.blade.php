...
@section('title', 'Создание нового сотрудника')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Создание нового сотрудника') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('registrationEmployeeMethod') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Зарегистрировать нового сотрудника') }}
                                </button>
                            </div>
                        </div>
                    </form>
