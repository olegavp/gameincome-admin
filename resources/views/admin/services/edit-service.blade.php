...
@section('content')
    ...
    <div class="card card-primary">
        <form enctype="multipart/form-data" action="{{ Route('serviceEdit', ['service' => $service->id]) }}" method="POST">
            @csrf
            @method('POST')
            <div class="card-body">
                <div class="form-group mt-4">
                    <label for="name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Название сервиса</font></font></label>
                    <input value="{{ $service->name }}" name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Введите название сервиса">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="{{ $service->background }}" alt="фон">
                    <br>
                    <br>
                ...
                <div class="card-footer">
                    <button class="btn btn-primary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Изменить сервис!</font></font></button>
                </div>
            </div>
        </form>
    </div>
