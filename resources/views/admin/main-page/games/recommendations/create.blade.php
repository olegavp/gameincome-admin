...
@section('title', 'Создание рекомендации')
...
@section('content')
    ...
    <div class="card card-primary">
        <form enctype="multipart/form-data" action="{{ Route('createRecommendation') }}" method="POST">
            @csrf
            @method('POST')
            <div class="card-body">
                ...
                <div class="card-footer">
                    <button class="btn btn-primary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Создать рекомендаию!</font></font></button>
                </div>
            </div>
        </form>
    </div>
