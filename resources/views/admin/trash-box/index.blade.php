    ...
    <div class="row ml-1 mr-1">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text"><a href="{{ Route('trashBoxNewsCommentsPage') }}">Комментарии</a></span>
                </div>
            </div>
        </div>
        ...
        <i class="mt-2 ml-3">Предметы из корзины, кроме пользователей удалить вручную невозможно. Они сами будут уничтожены безвазрвтно в течении 60 дней. А пользователи будут находиться в бане, пока их саморучно не разблокировать через корзину или через их профиль.</i>
    </div>
@endsection
